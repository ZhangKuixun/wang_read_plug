    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                dir = context.getApplicationContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = context.getApplicationContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
